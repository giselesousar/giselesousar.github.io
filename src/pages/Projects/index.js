...
class Projects extends React.Component{
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    <Nav style={{ width: "100%" }} className="mr-auto justify-content-center">
      ...
      <Nav.Link className="item active" href="http://giselesousar.github.io/projects">Projetos</Nav.Link>
      <Nav.Link className="item" href="http://giselesousar.github.io/contact">Contato</Nav.Link>
    </Nav>
  </Navbar.Collapse>
</Navbar>
</div>
